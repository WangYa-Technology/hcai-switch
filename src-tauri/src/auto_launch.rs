...
/// 将 `/path/to/HCAI Switch.app/Contents/MacOS/HCAI Switch` 转换为 `/path/to/HCAI Switch.app`
#[cfg(target_os = "macos")]
...
mod tests {
    ...
    fn test_get_macos_app_bundle_path_valid() {
        let exe_path =
            std::path::Path::new("/Applications/HCAI Switch.app/Contents/MacOS/HCAI Switch");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from("/Applications/HCAI Switch.app"))
        );
    }
    ...
    fn test_get_macos_app_bundle_path_with_spaces() {
        let exe_path =
            std::path::Path::new("/Users/test/My Apps/HCAI Switch.app/Contents/MacOS/HCAI Switch");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from(
                "/Users/test/My Apps/HCAI Switch.app"
            ))
        );
    }
